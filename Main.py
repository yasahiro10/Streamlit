...
print(val)
txt=st.text_input("Enter your password",type="password")
#print(txt)
txt1=st.text_area("Course Description")
print(txt1)
val1=st.date_input("Enter your Registration date")
print(val1)
st.time_input("Timer")
